...
public class AllTests_M4 {

	static {
		try {
			new LogSetup("logs/testing/M4test.log", Level.ERROR);
	...
	public static Test suite() {
		TestSuite clientSuite = new TestSuite("M4-Test-Suite");
		...
		clientSuite.addTestSuite(M4Tests.class);
		return clientSuite;
	}
